...
class List {
    ...
    create() {
        ...
        this.element.setAttribute(`style`, `transform: translate(${this.position}px , 0)`)
    }
    move(rate) {
        this.position += rate;
        this.element.setAttribute(`style`, `transform: translate(${this.position}px , 0)`)
        if (this.position <= this.element.offsetWidth * -3) {
            ...
            this.element.setAttribute(`style`, `transition: 0s all; transform: translate(${this.position}px , 0)`)
        }
    }
}
